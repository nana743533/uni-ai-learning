...
export default function FeedbackTab({ lectureTitle }: { lectureTitle: string }) {
    ...
    <div className="flex-1 overflow-y-auto px-4 py-6">
      <div className="max-w-lg mx-auto">
        <h3 className="text-base font-bold text-foreground mb-1">
          第1回「{lectureTitle}」の感想・要望
        </h3>
        <p className="text-xs text-muted-foreground mb-6">
          匿名で教授に送信されます。率直なご意見をお聞かせください。
        </p>

        {/* Rating */}
        <div className="mb-6">
          <p className="text-sm font-semibold text-foreground mb-3">授業の満足度</p>
